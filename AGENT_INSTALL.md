Russian version: [docs/ru/AGENT_INSTALL.md](./docs/ru/AGENT_INSTALL.md)

# totp-presence — agent install runbook

This file is the step-by-step runbook an AI agent follows when a human
asks it to install totp-presence. It is **not** guidance for working
on the totp-presence codebase — that lives in
[CLAUDE.md](./CLAUDE.md). Project description — in
[README.md](./README.md).
