...
Поиск по существующим работам (апрель 2026) не обнаружил более
раннего описания этой конкретной схемы — TOTP-кода от человека,
трактуемого как независимый от канала сигнал идентичности, который
ограничивает использование инструментов агентом. Смежные работы ниже.
