...
Перед настройкой выясни у человека:

1. **Какие инструменты защитить?** Узнай какие MCP-серверы
   подключены и какие встроенные тулы используются. Составь
   рекомендацию из доступных.
